...
### 목차
###
[1.프로토콜이란 무엇인가요?](#01-프로토콜이란-무엇인가요?)<br/>
[2.Network Core란 무엇인가요?](#02-network-core란-무엇인가요?)<br/><br/> 
[3.그렇다면 이러한 Network Core 에 의한 전달방식 2가지가 무엇인지 설명해주세요](#03-그렇다면-이러한-network-core-에-의한-전달방식-2가지가-무엇인지-설명해주세요)<br/><br/>  
[4. Circuit Switching 의 단점을 간략하게 설명해주세요](#04-circuit-switching-의-단점을-간략하게-설명해주세요)<br/><br/> 
---
